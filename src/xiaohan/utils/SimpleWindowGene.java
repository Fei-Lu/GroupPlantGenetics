...
public class SimpleWindowGene {
    ...
    public SimpleWindowGene(int chrLength, int windowSize, int windowStep) {
    ...
    public SimpleWindowGene(int chrLength, int windowSize) {
        this.chrLength = chrLength;
        this.windowSize = windowSize;
