...
public class IOUtils {
    ...
    public static BufferedReader getInFile(String infilsS) {
        BufferedReader br = null;
        try {
            if (infilsS.endsWith("gz")) {
                br = IOUtils.getTextGzipReader(infilsS);
            } else {
                br = IOUtils.getTextReader(infilsS);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static BufferedWriter getOutFile(String infilsS) {
        BufferedWriter bw = null;
        try {
            if (infilsS.endsWith("gz")) {
                bw = IOUtils.getTextGzipWriter(infilsS);
            } else {
                bw = IOUtils.getTextWriter(infilsS);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
