...
//1-46                        
    ...
    public HashMap<String, TIntArrayList> mergeFourDPos() {
        ...
        return finalFourDMap;// TraesCS1A02G001900.6.cds1------>list(position,---2,5)     relative Positions according to each cds
    }
 ...
 /* for (int i : alignedSegment) {
  ...
  int phylipNum=la.getPhylipNum();
        ...
        try {
            ...
            System.out.println("all cut position established, starting random cutting 5000 positions");
