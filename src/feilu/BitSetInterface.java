...
public interface BitSetInterface {
     ...
     * @return collector
     */
    public static Collector<Long, ?, BitSetInterface> collect(long numBits) {
        return new BitSetListCollector(numBits);
    }

    public static class BitSetListCollector implements Collector<Long, BitSetInterface, BitSetInterface> {
        ...
        @Override
        public Supplier<BitSetInterface> supplier() {
            return () -> new OpenBitSet(myNumBits);
        }

        @Override
        public BiConsumer<BitSetInterface, Long> accumulator() {
            return (BitSetInterface t, Long u) -> {
                t.fastSet(u);
            };
        }

        @Override
        public BinaryOperator<BitSetInterface> combiner() {
            return (BitSetInterface t, BitSetInterface u) -> {
                t.or(u);
                return t;
            };
        }
        ...
        @Override
        public Function<BitSetInterface, BitSetInterface> finisher() {
            return (BitSetInterface t) -> t;
        }
