 ...
 * @version $Id$
 */
public class OpenBitSet implements BitSetInterface, Cloneable, Serializable {
    ...
    public OpenBitSet(BitSetInterface cloneOBS) {
     ...
     */
    public static long intersectionCount(BitSetInterface a, BitSetInterface b) {
     ...
     * set is modified.
     */
    public static long unionCount(BitSetInterface a, BitSetInterface b) {
     ...
     */
    public static long andNotCount(BitSetInterface a, BitSetInterface b) {
     ...
     * Neither set is modified.
     */
    public static long xorCount(BitSetInterface a, BitSetInterface b) {
     ...
     * this = this AND other
     */
    public void intersect(BitSetInterface other) {
     ...
     * this = this OR other
     */
    public void union(BitSetInterface other) {
     ...
     */
    public void remove(BitSetInterface other) {
     ...
     * this = this XOR other
     */
    public void xor(BitSetInterface other) {
        int newLen = Math.max(myNumWords, other.getNumWords());
        ensureCapacityWords(newLen);
     ...
     */
    public void notXor(BitSetInterface other) {
        int newLen = Math.max(myNumWords, other.getNumWords());
        ensureCapacityWords(newLen);
     ...
     * see {@link intersect}
     */
    public void and(BitSetInterface other) {
        intersect(other);
    }
     ...
     * see {@link union}
     */
    public void or(BitSetInterface other) {
        union(other);
    }
     ...
     * see {@link andNot}
     */
    public void andNot(BitSetInterface other) {
        remove(other);
    }
     ...
     */
    public boolean intersects(BitSetInterface other) {
        int pos = Math.min(myNumWords, other.getNumWords());
        long[] thisArr = myBits;
        long[] otherArr = other.getBits();
        while (--pos >= 0) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BitSetInterface)) {
            return false;
        }
        BitSetInterface a;
        BitSetInterface b = (BitSetInterface) o;
