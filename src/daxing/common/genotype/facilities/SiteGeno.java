 ...
 */
public class SiteGeno extends BiSNP {
     ...
     * @param taxaNumber
     */
    public SiteGeno(short chr, int pos, char refBase, char altBase, String info, BitSet phase1, BitSet phase2, BitSet missing, int taxaNumber) {
     ...
     * @return
     */
    public SiteGeno getSubGenotypeByTaxa (int[] taxaIndices) {
        ...
        SiteGeno sgb = new SiteGeno(this.getChromosome(),this.getPosition(),
                AlleleEncoder.getAlleleBaseFromCoding(this.getReferenceAlleleByte()),
    ...
    public byte getGenotypeByte (int taxonIndex) {
        ...
        byte b1 = AlleleEncoder.genotypeMissingCoding;
        byte b2 = AlleleEncoder.genotypeMissingCoding;
     ...
     * @return
     */
    public static SiteGeno buildFromBinaryLine (ByteBuffer bb, int taxaNumber) {
        ...
        SiteGeno sgb = new SiteGeno(chr, pos, refBase, altBase, null, p1, p2, m, taxaNumber);
    ...
    /**
     * Build and return an object of {@link SiteGeno} from line of VCF format
     * @param line
     * @return
     */
    public static SiteGeno buildFromVCFLine (String line) {
        ...
        SiteGeno sgb = new SiteGeno(chr, pos, refBase, altBase, null, phase1, phase2, missingP, taxaNumber);
        return sgb;
    }
}
