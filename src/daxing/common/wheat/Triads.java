...
import daxing.common.utiles.PlotTools;
        ...
        try (BufferedWriter bw = IOTool.getWriter(outFile)) {
            ...
            for (int i = 0; i < triads.getTriadRecordNum(); i++) {
                ...
                for (int j = 0; j < 3; j++) {
                    ...
                    chr=pgf.getGene(geneIndex).getGeneRange().chr;
                    start=pgf.getGene(geneIndex).getGeneRange().start;
                    end=pgf.getGene(geneIndex).getGeneRange().end;
