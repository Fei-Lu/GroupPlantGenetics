 ...
 * @author Fei Lu
 */
public class GeneFeatureGetGeneCoordinate {
    Gene[] genes;
    //0 by position, 1 by sort
    int sortType = 0;
    public GeneFeatureGetGeneCoordinate () {}
    
    /**
     * Constructs a object from reading kgf (key gene feature) format 
     * @param infileS 
     */
    public GeneFeatureGetGeneCoordinate (String infileS,FastaByte genomef, String outfileS) {
        this.readFile(infileS);
        this.writeCDSSequence (genomef, outfileS);
    }
